      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-3xl mx-auto leading-relaxed">
            AutoForge Garage е модерен автосервиз във Варна, специализиран в предоставянето на цялостни решения за вашия автомобил. Нашият екип от сертифицирани механици използва последно поколение оборудване за диагностика и ремонт, гарантирайки прецизност и надеждност. Ние работим само с висококачествени части от доказани производители, за да осигурим дълъг живот и безупречна работа на вашия автомобил.
          </p>
        </motion.div>
