      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-primary-300">Вашият доверен партньор</span>
          </motion.div>
          ...
          <p className="max-w-2xl mx-auto text-lg sm:text-xl text-gray-400 leading-relaxed px-4">
            Експертни автомобилни услуги с над 10 години опит. Диагностика, ремонт и поддръжка на най-високо ниво.
          </p>
